...
const styles = StyleSheet.create({
 ...
 logoCircle: { width: 80, height: 80, borderRadius: 20, backgroundColor: '#007AFF', justifyContent: 'center', alignItems: 'center' },
 logoText: { color: '#fff', fontSize: 32, fontWeight: 'bold' },
 appName: { fontSize: 28, fontWeight: 'bold', color: '#1a365d', marginTop: 16 },
 subtitleText: { fontSize: 14, color: '#d69e2e', marginTop: 4, fontWeight: '500' },
