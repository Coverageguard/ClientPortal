...
export default function VerifyScreen() {
 ...
 <Text style={styles.successText}>Your information has been submitted for review. You will be notified once your coverage has been verified.</Text>
 </View>
 </View>
 );
 }
...
successTitle: { fontSize: 24, fontWeight: 'bold', color: '#276749', marginBottom: 12 },
